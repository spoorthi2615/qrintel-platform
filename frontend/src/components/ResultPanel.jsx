    ...
    >
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              ...
              <span className="text-slate-400 text-[10px] font-semibold uppercase tracking-wider">{payload_display}</span>
            </div>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <div className="glass p-5 flex flex-col items-center justify-center border border-slate-800/80 bg-slate-900/20">
          <span className="text-slate-500 text-[10px] font-bold uppercase tracking-wider mb-4">Risk Assessment</span>
        ...
        <div className="glass p-5 flex flex-col items-center justify-center border border-slate-800/80 bg-slate-900/20 min-h-[250px]">
          <span className="text-slate-500 text-[10px] font-bold uppercase tracking-wider mb-2">Trust Vector Radar</span>
      ...
      {breakdown && Object.keys(breakdown).length > 0 && status !== 'SAFE' && (
        <div className="glass p-5 border border-slate-800/80 bg-slate-900/40 mt-4 mb-4">
          <h4 className="text-slate-400 text-[10px] font-bold uppercase tracking-wider mb-4 flex items-center gap-2">
            ...
            {Object.entries(breakdown).map(([category, points], idx) => {
              ...
              return (
                <div key={idx} className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-[10px] text-slate-500 font-mono flex-grow whitespace-nowrap hidden sm:block">
                      ........................................
                    </span>
      ...
      <div className="glass p-4 border border-slate-800/80 bg-slate-900/10 mb-4">
        <h4 className="text-slate-400 text-[10px] font-bold uppercase tracking-wider mb-3">Threat Detection Log</h4>
      ...
      {threat_intel?.found && (
        <div className="glass p-4 border border-red-500/50 bg-red-900/20 mb-4 rounded-lg">
          <h4 className="text-red-400 text-[10px] font-bold uppercase tracking-wider mb-3 flex items-center gap-2">
            <AlertTriangle size={14} className="text-red-500" />
            THREAT INTELLIGENCE
          </h4>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800">
              <span className="block text-[10px] text-slate-500 uppercase">Feed Source</span>
            ...
            <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800">
              <span className="block text-[10px] text-slate-500 uppercase">First Seen</span>
            ...
            <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800">
              <span className="block text-[10px] text-slate-500 uppercase">Last Seen</span>
              <span className="text-xs font-mono font-bold text-slate-400 truncate block">
      ...
      {content_intel?.content_available && (
        <div className="glass p-4 border border-slate-800/80 bg-slate-900/20 mb-4">
          <h4 className="text-slate-400 text-[10px] font-bold uppercase tracking-wider mb-3 flex items-center gap-2">
            <Eye size={14} className="text-purple-400" />
            CONTENT INTELLIGENCE
          </h4>
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-3">
            <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800">
              <span className="block text-[10px] text-slate-500 uppercase">Forms</span>
              <span className="text-sm font-mono font-bold text-slate-200">{content_intel.form_count || 0}</span>
            </div>
            <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800">
              <span className="block text-[10px] text-slate-500 uppercase">Password Fields</span>
            ...
            <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800">
              <span className="block text-[10px] text-slate-500 uppercase">External Actions</span>
            ...
            <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800">
              <span className="block text-[10px] text-slate-500 uppercase">Target Brand</span>
            ...
            <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800 col-span-2">
              <span className="block text-[10px] text-slate-500 uppercase">Credential Harvesting Confidence</span>
      ...
      {brand_intel?.techniques?.length > 0 && (
        <div className="glass p-4 border border-orange-500/50 bg-orange-900/20 mb-4 rounded-lg">
          <h4 className="text-orange-400 text-[10px] font-bold uppercase tracking-wider mb-3 flex items-center gap-2">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800">
              <span className="block text-[10px] text-slate-500 uppercase">Technique</span>
            ...
            <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800">
              <span className="block text-[10px] text-slate-500 uppercase">Official Domain</span>
              <span className="text-xs font-mono font-bold text-slate-400 truncate block">
      ...
      {infra_intel && (infra_intel.registrar || infra_intel.domain_age_days > 0) && (
        <div className="glass p-4 border border-slate-800/80 bg-slate-900/20 mb-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800">
              <span className="block text-[10px] text-slate-500 uppercase">Domain Age</span>
            ...
            <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800 col-span-2 sm:col-span-1">
              <span className="block text-[10px] text-slate-500 uppercase">Registrar</span>
              <span className="text-sm font-bold text-slate-200 capitalize truncate block">
                {infra_intel.registrar || 'Hidden'}
              </span>
            </div>
            <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800">
              <span className="block text-[10px] text-slate-500 uppercase">SSL Valid</span>
              <span className={`text-sm font-bold ${infra_intel.ssl_valid ? 'text-emerald-400' : 'text-red-400'}`}>
                {infra_intel.ssl_valid ? 'Yes' : 'No'}
              </span>
            </div>
            <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800">
              <span className="block text-[10px] text-slate-500 uppercase">Infra Risk Score</span>
      ...
      {intelligence?.dns_intel && (
        <div className="glass p-4 border border-slate-800/80 bg-slate-900/20 mb-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800">
              <span className="block text-[10px] text-slate-500 uppercase">A Records</span>
              <span className="text-sm font-mono font-bold text-slate-200">
                {intelligence.dns_intel.a_records?.length || 0}
              </span>
            </div>
            <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800">
              <span className="block text-[10px] text-slate-500 uppercase">MX Records</span>
            ...
            <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800">
              <span className="block text-[10px] text-slate-500 uppercase">ASN</span>
              <span className="text-sm font-mono font-bold text-slate-200 truncate block">
                {intelligence.dns_intel.asn || 'Unknown'}
              </span>
            </div>
            <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800">
              <span className="block text-[10px] text-slate-500 uppercase">DNS Risk Score</span>
          ...
          {intelligence.dns_intel.reasons?.length > 0 && (
            <div className="mt-3 bg-red-500/5 border border-red-500/10 rounded p-2 text-[10px] text-red-400">
      ...
      {visual_intel?.target_brand && (
        <div className="glass p-4 border border-slate-800/80 bg-slate-900/20 mb-4">
          ...
          <div className="grid grid-cols-2 gap-3 mb-3">
            <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800">
              <span className="block text-[10px] text-slate-500 uppercase">Visual Impersonation</span>
              <span className="text-sm font-bold text-pink-400 capitalize">{visual_intel.target_brand}</span>
            </div>
            <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800">
              <span className="block text-[10px] text-slate-500 uppercase">Similarity Score</span>
      ...
      {intelligence?.visual_brand_intel && (
        <div className="glass p-4 border border-slate-800/80 bg-slate-900/20 mb-4">
          ...
          <div className="grid grid-cols-2 gap-3 mb-3">
            <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800">
              <span className="block text-[10px] text-slate-500 uppercase">OCR Status</span>
            ...
            <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800">
              <span className="block text-[10px] text-slate-500 uppercase">Logo Model Status</span>
          ...
          {intelligence.visual_brand_intel.ocr.brands_detected?.length > 0 && (
            <div className="mb-2 p-2 rounded bg-slate-900/50 border border-slate-800">
              <span className="text-[10px] text-slate-400 block mb-1">OCR Brands Detected:</span>
          ...
          {intelligence.visual_brand_intel.ocr.error && (
            <div className="p-2 rounded bg-red-900/20 border border-red-500/30 text-[10px] text-red-400 font-mono">
              {intelligence.visual_brand_intel.ocr.error}
            </div>
          )}
        </div>
          ...
          <CollapsibleCard id="trust" title="Trust Vector Analysis (Sprint 1)" icon={Shield} color="#3b82f6" defaultOpen={true}>
            <div className="space-y-3">
              ...
              {intelligence.trust.top_concerns?.length > 0 && (
                <div className="bg-red-500/5 border border-red-500/10 rounded-lg p-2 text-[10px] text-red-400">
              ...
              {tamper_analysis.explanations?.length > 0 ? (
                <div className="space-y-1.5">
                  {tamper_analysis.explanations.map((exp, i) => (
                    <div key={i} className="flex justify-between p-2 rounded bg-slate-900/40 border border-slate-800/30 text-[10px]">
                ...
                <div className="text-[10px] text-slate-500 italic">No physical anomalies detected.</div>
              )}
            </div>
          </CollapsibleCard>
        )}
          ...
          <CollapsibleCard id="phishing" title="Visual Phishing Engine (Sprint 3)" icon={Eye} color="#eab308" defaultOpen={false}>
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3 bg-slate-900/30 p-2 rounded border border-slate-800/40">
                <div>
                  <span className="text-slate-500 block text-[9px] uppercase">Detected Brand</span>
                  <span className="text-slate-200 font-semibold">{intelligence.visual_phishing.brand_detected || "None"}</span>
                </div>
                <div>
                  <span className="text-slate-500 block text-[9px] uppercase">Triggered Signals</span>
          ...
          <CollapsibleCard id="graph" title="Behavioral Trust Graph (Sprint 4)" icon={Network} color="#22c55e" defaultOpen={false}>
            <div className="space-y-3">
              <div className="grid grid-cols-3 gap-2 text-center bg-slate-900/40 p-3 rounded-lg border border-slate-800/40">
                <div>
                  <p className="text-slate-600 uppercase text-[8px] tracking-wider">New Vertex Anomaly</p>
                  <p className="text-slate-200 font-bold mt-0.5">{intelligence.graph.new_node_anomaly_score?.toFixed(1) || 0}</p>
                </div>
                <div>
                  <p className="text-slate-600 uppercase text-[8px] tracking-wider">Added Nodes</p>
                  <p className="text-slate-200 font-bold mt-0.5">{intelligence.graph.nodes_added ?? 0}</p>
                </div>
                <div>
                  <p className="text-slate-600 uppercase text-[8px] tracking-wider">Added Edges</p>
              ...
              <div className="space-y-2 text-[10px] text-slate-400">
                ...
                {intelligence.campaign.ttp_fingerprint && (
                  <div className="border-t border-slate-800/50 pt-2 space-y-1.5">
                    ...
                    <div className="grid grid-cols-2 gap-2 text-[9px] bg-slate-900/30 p-2 rounded">
        ...
        {intelligence?.related_threats && (
          <CollapsibleCard id="related" title="Related Threats (Sprint 5)" icon={Network} color="#06b6d4" defaultOpen={false}>
            <div className="space-y-3">
              <div className="grid grid-cols-2 gap-3">
                <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800">
                  <span className="block text-[10px] text-slate-500 uppercase">Related Campaign</span>
                  <span className="text-sm font-bold text-cyan-400">
                    {intelligence.related_threats.related_campaigns?.length > 0 ? intelligence.related_threats.related_campaigns[0] : "None"}
                  </span>
                </div>
                <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800">
                  <span className="block text-[10px] text-slate-500 uppercase">Related URLs</span>
                  <span className="text-sm font-mono font-bold text-slate-200">
                ...
                <div className="col-span-2 p-2.5 rounded-lg bg-slate-900 border border-slate-800">
                  <span className="block text-[10px] text-slate-500 uppercase">Relationship Confidence</span>
      ...
      {payload_type === 'UPI' && upi_fields && Object.keys(upi_fields).length > 0 && (
        <div className="glass p-4 border border-slate-800/80 bg-amber-500/5">
          <span className="text-[10px] font-bold text-amber-500 uppercase tracking-wider block mb-2">UPI Transaction Fields</span>
          <div className="grid grid-cols-2 gap-2">
            {Object.entries(upi_fields).map(([k, v]) => (
              <div key={k} className="p-2 rounded bg-slate-950/40 border border-slate-800/50 text-[10px]">
